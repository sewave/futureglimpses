...
static AnimationData SOLDIER_ATTACK_ANIMATION_DATA = {
		.type = ANIMATION_TYPE_ONCE,
		.frames = {
            {.duration = SEC_TO_FRAMES(0.35)},
            {.duration = SEC_TO_FRAMES(0.1)},
...
static const AnimationPropsData SOLDIER_ATTACK = {
    .props = ATTACK_PROPERTIES,
    .data = &SOLDIER_ATTACK_ANIMATION_DATA,
};
...
static AnimationPropsData UNIT_ANIMATIONS[UNIT_TYPE_NUMBER][UNIT_STATES_COUNT] = {
		...
		[UNIT_TYPE_SOLDIER] = {COMMON_IDLE, SOLDIER_ATTACK, COMMON_IDLE, WORKER_MOVE, WORKER_MOVE, WORKER_MOVE, WORKER_ATTACK, COMMON_DIE},
		[UNIT_TYPE_ARCHER] = {COMMON_IDLE, ARCHER_ATTACK, COMMON_IDLE, WORKER_MOVE, WORKER_MOVE, WORKER_MOVE, WORKER_ATTACK, COMMON_DIE},
		[UNIT_TYPE_KNIGHT] = {COMMON_IDLE, SOLDIER_ATTACK, COMMON_IDLE, WORKER_MOVE, WORKER_MOVE, WORKER_MOVE, WORKER_ATTACK, COMMON_DIE},
