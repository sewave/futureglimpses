...
static const AnimationPropsData B_BUILD_CREATE = {
    .props = BIG_BUILDING_CREATE_PROPERTIES,
    .data = &BUILDING_ANIMATION_DATA,
};
...
static AnimationPropsData UNIT_ANIMATIONS[UNIT_TYPE_NUMBER][UNIT_STATES_COUNT] = {
		...
		// UNIT_TYPE_BARRACKS
		{B_BUILD_IDLE, B_BUILD_IDLE, B_BUILD_CREATE, B_BUILD_IDLE, B_BUILD_IDLE, B_BUILD_IDLE, B_BUILD_IDLE, B_BUILD_DESTROY},
