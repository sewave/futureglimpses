...
#define MAP_OPTION_ENABLE_TURRET_INDEX 6
#define MAP_OPTION_AI_MODE_INDEX 7
...
MapData *game_map_load_data(const char *filename) {
	...
	map->enableTurret = mapOptions[MAP_OPTION_ENABLE_TURRET_INDEX];
