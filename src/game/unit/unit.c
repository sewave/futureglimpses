...
static TrainingResourcesData trainingResources[TRAINING_TYPE_NUMBER] = {
	...
	[TRAINING_TYPE_ARCHER]			= {.used = {500, 50, 1}, .time = SEC_TO_FRAMES(23), .foodProvided = 0},
	[TRAINING_TYPE_KNIGHT]			= {.used = {800, 100, 1}, .time = SEC_TO_FRAMES(30), .foodProvided = 0},
	[TRAINING_TYPE_MAGE]			= {.used = {900, 200, 1}, .time = SEC_TO_FRAMES(62), .foodProvided = 0},
	...
	[TRAINING_TYPE_TURRET]			= {.used = {800, 200, 0}, .time = SEC_TO_FRAMES(20), .foodProvided = 0},
	[TRAINING_TYPE_UPGRADE_SOLDIER]	= {.used = {2400, 0, 0}, .time = SEC_TO_FRAMES(50), .foodProvided = 0},
	[TRAINING_TYPE_UPGRADE_ARCHER]	= {.used = {2000, 200, 0}, .time = SEC_TO_FRAMES(75), .foodProvided = 0},
	[TRAINING_TYPE_UPGRADE_KNIGHT]	= {.used = {3600, 400, 0}, .time = SEC_TO_FRAMES(90), .foodProvided = 0},
	[TRAINING_TYPE_UPGRADE_MAGE]	= {.used = {3600, 800, 0}, .time = SEC_TO_FRAMES(110), .foodProvided = 0},
};
